...
Mini CRM (Customer Relationship Management) system developed with a focus on managing a speaker’s schedule, allowing the organization of appointments, events, clients, and contact information in a practical and efficient way. The application simulates a real corporate environment, helping control lectures, meetings, scheduled dates, event locations, and request tracking.

The project is being developed using HTML, CSS, JavaScript, and PHP, with MySQL database integration for data storage and management. The system includes features such as client and event registration, schedule management, search, editing, and record deletion, along with a modern, responsive, and intuitive interface designed to simplify the management of the speaker’s activities.
